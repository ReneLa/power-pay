...
const Emergency = ({ navigation }) => {
  ...
  let emergency =
    "Please  bare with  us  as  we  are  planning  to  repair bobbin  on  your  Area,  and  we  are  expecting  to  cut  off  electricity  from  1Am  to   5AM";
  let date = new Date()
  return (
    <ActionButton
...
export default connect(null, {})(Emergency);
